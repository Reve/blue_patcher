...
namespace blue_patcher
{
    ...
    //latest cru FF 6A 00 6A 00 52 2B C1 50 8B 85 C8 FA FF FF 51 50 C6 85 CF FA FF FF 01 FF 15 00 80 15 10 8B 8D C8 FA FF FF 51 8B F0 FF 15 1C 80 15 10 85 F6 0F 85
